...
import { Bot, Activity, Clock, ChevronRight, Loader2, Snowflake, BadgeCheck } from 'lucide-react';
            ...
            {agents.map((agent) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center text-white text-xl font-bold shrink-0">
